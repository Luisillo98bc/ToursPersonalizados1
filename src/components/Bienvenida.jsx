...
const Bienvenida = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center gap-8  md: py-16  max-w-7xl mx-auto px-4">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
        ...
        <p className="text-gray-600 leading-relaxed">
          Es un placer darles la bienvenida al majestuoso Valle del Mantaro, un
          destino que combina tradición, naturaleza y hospitalidad andina.
          Nuestra misión es ofrecerles una experiencia auténtica y memorable, ya
          sea que viajen en pareja, con amigos o en familia —¡incluso junto a
          sus mascotas!
        </p>
        <p className="text-gray-600 leading-relaxed">
          ...
          cultural vibrante, invita a cada visitante a descubrir la esencia viva
          de nuestros pueblos y la calidez de su gente.
        </p>
